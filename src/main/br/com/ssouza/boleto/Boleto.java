...
public class Boleto {
	...
	private static final Calendar DATA_BASE_FATOR = DateUtils.getPrimeiraHoraDoDia(7, 10, 1997);
	...
	public String getFatorVencimento () {
		...
		Calendar dataVencimento = DateUtils.getPrimeiraHoraDoDia(day, month + 1, year);
